...
-->
<img src="./docs/demo.gif" width="800" alt="Midmar dashboard demo — replace with your own recording" />
...
Midmar is a full-stack platform that helps football (soccer) clubs make data-backed decisions:
...
> Note: the GitHub repo itself is still named `FOOTBRAIN` (rename it on GitHub if you want the folder to say `Midmar` too — the code doesn't care either way).
